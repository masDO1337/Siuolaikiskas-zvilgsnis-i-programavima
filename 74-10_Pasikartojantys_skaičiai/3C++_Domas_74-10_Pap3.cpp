...
#include <cmath>
using namespace std;
const char CDfv[] = "DuomenysPS_74-10_Pap3.txt";
const char CRfv[] = "RezultatasPS3.txt";
const int CMax    = 1000;
//-------------------------------------------------------------------
void Skaityti(const char fv[], int A[], int & n, int & m);
...
void Skaityti(const char fv[], int A[], int & n, int & m)
{
   ...
   fd >> n >> m; // perskaitomas masyvo reiksmiu kiekis
   for (int i = 0; i < n; i++)
      fd >> A[i];
